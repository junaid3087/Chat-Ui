...
<!-- Button positioned on the left side outside and adjacent to the container -->
<div class="btn-file-upload-left" on:click={handleButtonClick} bind:this={buttonRef}>
